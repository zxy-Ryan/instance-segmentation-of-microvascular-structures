...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        ann_file=
        './datasets/hubmap2023/annotations_json_c1/coco_annotations_train_all_fold1.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='./datasets/hubmap2023/',
        ann_file=
        './datasets/hubmap2023/annotations_json_c1/coco_annotations_valid_all_fold1.json',
        data_prefix=dict(img='train/'),
        test_mode=True,
        pipeline=[
            dict(type='LoadImageFromFile', backend_args=None),
