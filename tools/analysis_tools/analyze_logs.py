...
def main():
    args = parse_args()
    args.json_logs = ['./mymmdet/result_train/result_cmrcnn_r50_40epoch_1c_aug/20230729_002500/vis_data/20230729_002500.json']
    # args.keys = ['loss', 'loss_rpn_cls', 'loss_rpn_bbox']
    # args.keys = ['s0.loss_cls', 's1.loss_cls', 's2.loss_cls']
    # args.keys = ['s0.loss_bbox', 's1.loss_bbox', 's2.loss_bbox']
    # args.keys = ['s0.loss_mask', 's1.loss_mask', 's2.loss_mask']
    args.keys = ['segm_mAP', 'segm_mAP_50', 'segm_mAP_75', 'segm_mAP_s', 'segm_mAP_m', 'segm_mAP_l']
    args.out = './mymmdet/result_train/result_cmrcnn_r50_40epoch_1c_aug/20230729_002500/vis_data/mAP.jpg'
