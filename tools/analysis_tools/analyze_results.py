...
def main():
    args = parse_args()
    args.config = './mymmdet/mmdetection/configs/HubMap/custom_config_cascade-mask-rcnn_r50_fpn_1x_coco_1024_1024_1c.py'
    args.prediction_path = './mymmdet/result_valid/results.pkl'
    args.show_dir = './mymmdet/result_valid/show'
    args.show_score_thr = 0.6
